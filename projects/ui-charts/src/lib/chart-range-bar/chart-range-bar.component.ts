...
export class UiRangeBarChartComponent implements OnDestroy {
  ...
  readonly plotOptions = input<ApexPlotOptions>({ bar: { horizontal: true } });
  ...
  readonly chartConfig = computed<ApexChart>(() => ({ ...this.defaults.chart, type: 'rangeBar', height: this.height() }));
