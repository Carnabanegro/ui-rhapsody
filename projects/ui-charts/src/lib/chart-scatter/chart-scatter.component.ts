...
export class UiScatterChartComponent implements OnDestroy {
  ...
  readonly markers = input<ApexMarkers>({ size: 6 });
  ...
  readonly chartConfig = computed<ApexChart>(() => ({ ...this.defaults.chart, type: 'scatter', height: this.height() }));
